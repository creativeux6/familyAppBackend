...
class UpdateFamilyInfoRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'spouses.*.confirm_create_new' => ['sometimes', 'boolean'],
            'spouses.*.first_name' => ['nullable', 'string', 'max:255'],
            'spouses.*.last_name' => ['nullable', 'string', 'max:255'],
            'spouses.*.date_of_birth' => ['nullable', 'date'],
            'spouses.*.date_of_death' => ['nullable', 'date'],
            ...
            'spouses.*.father.uuid' => ['nullable', 'uuid'],
            'spouses.*.father.first_name' => ['nullable', 'string', 'max:255'],
            'spouses.*.father.last_name' => ['nullable', 'string', 'max:255'],
            'spouses.*.father.date_of_birth' => ['nullable', 'date'],
            'spouses.*.father.date_of_death' => ['nullable', 'date'],
            'spouses.*.father.gender' => ['nullable', Rule::in(['male', 'female', 'other', 'unknown'])],
            'spouses.*.father.is_living' => ['sometimes', 'boolean'],
            'spouses.*.mother' => ['sometimes', 'nullable', 'array'],
            'spouses.*.mother.uuid' => ['nullable', 'uuid'],
            'spouses.*.mother.first_name' => ['nullable', 'string', 'max:255'],
            'spouses.*.mother.last_name' => ['nullable', 'string', 'max:255'],
            'spouses.*.mother.date_of_birth' => ['nullable', 'date'],
            'spouses.*.mother.date_of_death' => ['nullable', 'date'],
            'spouses.*.mother.gender' => ['nullable', Rule::in(['male', 'female', 'other', 'unknown'])],
            'spouses.*.mother.is_living' => ['sometimes', 'boolean'],
